...
public class Day4
{
    ...
    [Theory]
    public void AnyOverlappingAssignments_listOfAssignments_AreAssignmentsOverlapping(int firstLowerLimit, int firstUpperLimit, 
        int secondLowerLimit, int secondUpperLimit, bool expectedOverlapping)
    {
        var assigments = new List<Assignment>
        {
        ...
        var actualOverlapping = Days.Day4.AnyOverlappingAssignments(assigments);
        Assert.Equal(actualOverlapping, expectedOverlapping);
    }
    [Fact]
